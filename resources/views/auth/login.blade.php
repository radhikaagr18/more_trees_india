...
<div class="col-sm-12 col-lg-8 col-md-8 ">
    ...
    <ol class="carousel-indicators">
        <li data-target="#carouselExampleIndicators align-middle" data-slide-to="0" class="active"></li>
        <li data-target="#carouselExampleIndicators align-middle    " data-slide-to="1"></li>
    ...
    <div class="modal fade " id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="row">
                <div class="col-sm-0 col-lg-7 col-md-7"></div>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="email" class="col-md-12 col-form-label text-md-left">{{ __('E-Mail Address') }}</label><br>
